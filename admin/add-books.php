	...
	<form method="post" action="add-books.php" enctype="multipart/form-data">
	  ...
	  <div class="form-group">
	   ...
	   <div class="form-group">
	    ...
	    <input type="number" step="any" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter price">
	  <div class="form-group">
...
<?php
	...
	if(isset($_POST['add_button'])){
		...
		$query2 = "Insert into Books (category_id, title, price, author, date, image, details) values ($category_id, '$title', '$price', '$author', '$date', '$image', '$details')";
