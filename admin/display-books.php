...
<?php
	...
	echo "<center><br><h1>Displaying data from Books table</h1></center><br>";
	
	$query = "select b.books_id, b.title, b.price, b.date, b.details, c.category_name from Books b, Category c where b.category_id = c.category_id;";
	...
	if($result){
        ...
        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
            ...
            <td class='details' align='center'>
            	<textarea rows = 4 cols=50 class='form-control details2' name='details[$i]'>$row[details]</textarea 
            </td>
